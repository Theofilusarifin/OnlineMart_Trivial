...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2021 at 10:59 PM
...
INSERT INTO `barangs` (`id`, `nama`, `harga`, `kategori_id`) VALUES
(1, 'Nasi Goreng Pedas', '7500', 2),
(2, 'masako', '2500', 5),
(4, 'Ayam Goreng', '16000', 2),
(6, 'Chikin Taro', '5000', 2),
(7, 'Walls', '7000', 12),
(8, 'Indomie', '3500', 2),
(9, 'Steak', '25000', 2),
(10, 'Boba', '10000', 3),
...
(12, 'Laptop', '3000000', 7),
(13, 'Kabel', '60000', 7),
(14, 'Your Name', '10000', 6),
(15, 'Your Lie In April', '10000', 8),
(16, 'My Hero Academia', '10000', 8),
(17, 'Weathering With You', '10000', 6);
...
CREATE TABLE `chats` (
  ...
  `role_pengirim` enum('driver','konsumen') DEFAULT NULL,
  `order_id` bigint(19) UNSIGNED NOT NULL,
...
INSERT INTO `chats` (`id`, `isi`, `waktu`, `role_pengirim`, `order_id`, `driver_id`, `pelanggan_id`) VALUES
(5, 'a', '2021-11-23 05:45:23', 'konsumen', 202111250001, 2, 4),
(6, 'aaa', '2021-11-23 05:45:26', 'driver', 202111250001, 2, 4),
(7, 'yo', '2021-11-23 05:47:47', 'konsumen', 202111250001, 2, 4),
(8, 'aa', '2021-11-23 17:47:37', 'konsumen', 202111250001, 2, 4),
(9, 'yesy', '2021-11-23 17:47:42', 'konsumen', 202111250001, 2, 4),
(10, 'test', '2021-11-27 00:26:05', 'konsumen', 202111250001, 2, 4),
(11, 'woke', '2021-11-27 00:28:59', 'driver', 202111250001, 2, 4),
(12, 'siap', '2021-11-27 00:29:04', 'driver', 202111250001, 2, 4),
(13, 'Test', '2021-11-27 00:29:29', 'konsumen', 202111250001, 2, 4),
(14, 'Halo', '2021-11-28 16:55:37', 'konsumen', 202111280001, 2, 4),
(15, 'Halo  Juga', '2021-11-28 16:55:58', 'driver', 202111280001, 2, 4),
(16, 'Yoi men', '2021-11-28 16:56:32', 'konsumen', 202111280001, 2, 4);
...
INSERT INTO `orders` (`id`, `tanggal_waktu`, `alamat_tujuan`, `ongkos_kirim`, `total_bayar`, `cara_bayar`, `status`, `driver_id`, `cabang_id`, `metode_pembayaran_id`, `promo_id`, `gift_redeem_id`, `pelanggan_id`) VALUES
(202111250001, '2021-11-25 18:26:14', 'Medokan Asri', 10000, 7500, 'Transfer', 'Order Selesai', 2, 1, 1, 1, 1, 4),
(202111280001, '2021-11-28 16:54:25', 'Rungkut Kalibata', 10000, 10000, 'Transfer', 'Pesanan Diproses', 2, 1, 1, 1, 1, 4),
(202111280002, '2021-11-28 23:19:40', 'Jln Tenggilis Jaya Utara Selatan', 10000, 10000, 'Transfer', 'Pesanan Diproses', 2, 1, 4, 5, 1, 4),
(202111280003, '2021-11-28 23:20:41', 'Ngangel', 10000, 5000, 'Transfer', 'Pesanan Diproses', 2, 1, 1, 3, 1, 4),
(202111280004, '2021-11-28 23:45:28', 'Jln Mawar 13', 10000, 15000, 'Transfer', 'Pesanan Diproses', 1, 1, 1, 1, 1, 4),
(202111280005, '2021-11-28 23:45:39', 'Jln Melati 13', 10000, 12500, 'Transfer', 'Pesanan Diproses', 2, 1, 1, 1, 1, 4),
(202111280006, '2021-11-28 23:51:40', 'Jln Anggrek 13', 10000, 2500, 'Transfer', 'Pesanan Diproses', 2, 1, 2, 2, 1, 4);
...
(2, 'yaska', 'yaska', 'yaska@gmail.com', 'b109f3bbbc244eb82441917ed06d618b9008dd09b3befd1b5e07394c706a8bb980b1d7785e5976ec049b46df5f1326af5a2ea6d103fd07c95385ffab0cacbc86', '1083103810', 0, 0),
...
(4, 'arifin', 'arifin', 'arifin@gmail.com', 'b109f3bbbc244eb82441917ed06d618b9008dd09b3befd1b5e07394c706a8bb980b1d7785e5976ec049b46df5f1326af5a2ea6d103fd07c95385ffab0cacbc86', '1932218310', 9970000, 10000),
(5, 'ivan', 'ivan', 'ivan@gmail.com', 'b109f3bbbc244eb82441917ed06d618b9008dd09b3befd1b5e07394c706a8bb980b1d7785e5976ec049b46df5f1326af5a2ea6d103fd07c95385ffab0cacbc86', '1932218', 0, 0),
...
ALTER TABLE `chats`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_chats_orders1_idx` (`order_id`,`driver_id`,`pelanggan_id`);
...
--
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`,`driver_id`,`pelanggan_id`),
...
--
ALTER TABLE `chats`
  ADD CONSTRAINT `fk_chats_orders1` FOREIGN KEY (`order_id`,`driver_id`,`pelanggan_id`) REFERENCES `orders` (`id`, `driver_id`, `pelanggan_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
