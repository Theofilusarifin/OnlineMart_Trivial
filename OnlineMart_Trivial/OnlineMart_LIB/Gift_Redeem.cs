...
namespace OnlineMart_LIB
{
    public class Gift_Redeem
    {
        ...
        #region Methods
        public static Boolean TambahData(Gift_Redeem gr, Koneksi kParram)
		{
			// Querry Insert
        ...
        public static Boolean UbahData(Gift_Redeem gr, Koneksi kParram)
		{
			// Querry Insert
		...
		public static Boolean HapusData(Gift_Redeem gr, Koneksi kParram)
		{
